...
load Tot_correlations_0_1000_0_2000_0_2000_400bsl.mat

% RespRat=pvalRat(:,1)<0.05;

[ValOutRat, ValInRat, SalOutRat, SalInRat]= anacorr_Rat(pvalRatbsl);
[ValOutLikRat, ValInLikRat, SalOutLikRat, SalInLikRat]= anacorr_Rat(pvalLikRatbsl);

[ValOutA1,ValA_A1,ValB_A1,ValAbsPrefA1,SalA_A1,SalB_A1,Diff_A1,AbsDiff_A1,Sum_A1,SalSum_A1,AbsSum_A1, ValC_A1,ValU_A1,SalC_A1,SalU_A1] = anacorr_AFC(pvalA1bsl);
[ValOutB,  ValA_B, ValB_B, ValAbsPrefB, SalA_B, SalB_B, Diff_B, AbsDiff_B, Sum_B, SalSum_B, AbsSum_B, ValC_B,ValU_B,SalC_B,SalU_B] = anacorr_AFC(pvalBbsl);
[ValOutA2,ValA_A2,ValB_A2,ValAbsPrefA2,SalA_A2,SalB_A2,Diff_A2,AbsDiff_A2,Sum_A2,SalSum_A2,AbsSum_A2, ValC_A2,ValU_A2,SalC_A2,SalU_A2] = anacorr_AFC(pvalA2bsl);
[ValOutLik, ValA_Lik, ValB_Lik, ValAbsPrefLik, SalA_Lik, SalB_Lik, Diff_Lik, AbsDiff_Lik, Sum_Lik, SalSum_Lik, AbsSum_Lik, ValC_lik,ValU_lik,SalC_lik,SalU_lik] = anacorr_AFC(pvalLikAFCbsl);

[ValOutA1_B,ValA_A1_B,ValB_A1_B,ValAbsPrefA1_B,SalA_A1_B,SalB_A1_B,Diff_A1_B,AbsDiff_A1_B,Sum_A1_B,SalSum_A1_B,AbsSum_A1_B, ValC_A1_B,ValU_A1_B,SalC_A1_B,SalU_A1_B] = anacorr_AFC(pvalA1_Bbsl);
[ValOutB_A2,ValA_B_A2,ValB_B_A2,ValAbsPrefB_A2,SalA_B_A2,SalB_B_A2,Diff_B_A2,AbsDiff_B_A2,Sum_B_A2,SalSum_B_A2,AbsSum_B_A2, ValC_B_A2,ValU_B_A2,SalC_B_A2,SalU_B_A2] = anacorr_AFC(pvalB_A2bsl);
[ValOutA1_Babs,ValA_A1_Babs,ValB_A1_Babs,ValAbsPrefA1_Babs,SalA_A1_Babs,SalB_A1_Babs,Diff_A1_Babs,AbsDiff_A1_Babs,Sum_A1_Babs,SalSum_A1_Babs,AbsSum_A1_Babs, ValC_A1_Babs,ValU_A1_Babs,SalC_A1_Babs,SalU_A1_Babs] = anacorr_AFC(pvalA1_Babsbsl);
[ValOutB_A2abs,ValA_B_A2abs,ValB_B_A2abs,ValAbsPrefB_A2abs,SalA_B_A2abs,SalB_B_A2abs,Diff_B_A2abs,AbsDiff_B_A2abs,Sum_B_A2abs,SalSum_B_A2abs,AbsSum_B_A2abs,ValC_B_A2abs,ValU_B_A2abs,SalC_B_A2abs,SalU_B_A2abs] = anacorr_AFC(pvalB_A2absbsl);
