function [pottlm, compFval, interceptPval]= Potthoff_analysis(RTin, valin)
...
tbl= table(zscore(RT), zscore(val), group, 'VariableNames', {'RT', 'val', 'group' });

pottlm{1} = fitlm(tbl, 'RT~val');
pottlm{2} = fitlm(tbl, 'RT~val*group');
dof1=2;
dof2=4;
